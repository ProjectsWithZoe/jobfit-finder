  ...
  const steps = [
    {
      ...
      description:
        "Simply upload your resume or copy-paste its content into our platform.",
    },
    {
      number: "02",
    ...
    },
    {
      ...
      description:
        "Our AI analyzes both documents and shows how well your profile matches the job requirements.",
    },
    {
      number: "04",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Our simple process helps you match your skills with job requirements
